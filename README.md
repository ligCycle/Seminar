...
เว็บลงทะเบียนงานสัมมนา เก็บข้อมูลผู้เข้าร่วมลง PostgreSQL พร้อมระบบ **QR code เช็คอิน** และหน้า **Admin** ดู/export รายชื่อ

## ฟีเจอร์
- ฟอร์มลงทะเบียน (ชื่อ อีเมล เบอร์ องค์กร ตำแหน่ง รอบสัมมนา อาหาร ฯลฯ) + ยินยอม PDPA
- สร้าง QR code ให้ผู้ลงทะเบียนไว้เช็คอินหน้างาน
- หน้า Admin: ดูรายชื่อ ค้นหา สถิติ และ export เป็น CSV (เปิดใน Excel ภาษาไทยได้)
- หน้าเช็คอิน: สแกน QR ด้วยกล้อง หรือกรอกรหัสมือ กันเช็คอินซ้ำ
...
4. เปิดเบราว์เซอร์
   ...
   - หน้าเช็คอิน: <http://localhost:3000/checkin.html>
...
- หน้า Admin/เช็คอิน ป้องกันด้วยรหัสผ่านเดียว — เหมาะกับงานทั่วไป หากต้องการหลายผู้ใช้ค่อยขยายภายหลัง
